...
import sys, os
simple_HRNet_path = "/home/jspark/simple-HRNet/"
sys.path.insert(0, simple_HRNet_path + "models")
sys.path.insert(0, simple_HRNet_path)

from SimpleHRNet import SimpleHRNet


def simpleHRNet_module():
    def __init__(self, hrnet_m='HRNet', hrnet_c =48, hrnet_j=17, hrnet_weights=simple_HRNet_path + "/weights/pose_hrnet_w48_384x288.pth", 
          hrnet_joints_set = "coco", image_resolution ='(384, 288)',
         single_person = False, disable_tracking = False, max_batch_size = 16, device =None):
    ...
    def eval_predict_oks(self, image_path):
...
class YOLOLayer(nn.Module):
    ...
    def __init__(self, anchors, num_classes, img_dim=416):
        ...
        self.pose_model = simpleHRNet_module()
